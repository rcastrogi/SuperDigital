...
GO
PRINT N'Creating [dbo].[ContaCorrente]...';
...
GO
PRINT N'Creating unnamed constraint on [dbo].[ContaCorrente]...';


GO
ALTER TABLE [dbo].[ContaCorrente]
...
ALTER TABLE [dbo].[Lancamento]
    ADD DEFAULT getdate() FOR [DtLancto];
